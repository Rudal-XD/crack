    ...
    if masuk in ['1','01']:#line:51
      ...
      if len (token)==0 :#line:55
        ...
        with requests .Session ()as login :#line:58   #### ISI TOKEN LU DAN   ID LU
          ...
          masuk =requests.get(f'https://app.cryptolens.io/api/key/activate?token=WyIxNjk4MzkyOCIsIktFWUhHaUJzQkZzcEpTdXFRMXh0ZUh3U0crOWpyNk9LM1ZWV0xSQlkiXQ==&ProductId=14877&Key={token}&Sign=True').json ()['licenseKey']#line:59
      ...
      exit (f"{P}[{M}!{P}]{M} Wrong Input");os.system('python run.py')
